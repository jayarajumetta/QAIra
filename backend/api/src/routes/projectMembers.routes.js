...
module.exports = async function (fastify) {
  fastify.post("/project-members", async (req) => {
    fastify.validate({
  ...
  fastify.delete("/project-members/:id", async (req) => {
